          ...
          <div class="min-w-full overflow-auto">
            ...
            <div v-else>
              <div class="flex items-center justify-center">
                ...
                <div class="ml-2 text-center py-4">入出庫履歴がありません</div>
              </div>
            </div>
          </div>
        </main>
        <footer class="modal__footer">
          <button @click="closeModal" type="button" class="modal__btn" data-micromodal-close aria-label="Close this dialog window">閉じる</button>
        </footer>
      </div>
    </div>
  </div>
