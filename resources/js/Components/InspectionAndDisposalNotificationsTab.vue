...
watch(
  () => props.inspectionAndDisposalNotifications,
  ...
  <div>
    <div class="flex justify-around items-center">
      ...
      <Link
        ...
        class="px-4 text-blue-600 title-font font-medium text-xs md:text-base underline"
      >
        点検と廃棄へ
      </Link>
    </div>
    ...
    <div class="min-w-full overflow-auto flex justify-center">
      <table
        v-if="Object.keys(inspectionAndDisposalNotifications).length > 0"
      ...
      >
        ...
        <tbody>
          <tr
            v-for="notification in inspectionAndDisposalNotifications"
            :key="notification.id"
