                            ...
                            <div class="flex flex-col md:space-x-4 lg:space-x-12 lg:flex-row justify-center items-center pl-4 mt-4 lg:mt-6 w-full">
                              ...
                              <div class="w-full mt-4 lg:mt-0 md:w-1/2 flex justify-center lg:justify-start space-x-4 md:space-x-0 self-center">
                                ...
                                <div class="flex items-center relative">
                                  <input type="text" id="search" name="search" v-model="search" placeholder="備品名で検索" @keyup.enter="fetchAndFilterItems" class="h-9 md:w-60 text-sm md:text-base placeholder-text-xs md:placeholder-text-base">
                                  <div v-if="isMobileDevice" class="absolute right-10 md:right-11">
                                    <!-- <ToolTip /> -->
                                    <QrCodeReader />
                                  </div>
                                  <button id="searchButton" class="h-9 w-9 md:w-10 bg-blue-300 text-white py-2 px-2 flex justify-center items-center border border-gray-300" @click="fetchAndFilterItems">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                ...
                                <div class="w-full p-2 border">
                                  <div>
                                    ...
                                    <div class="mt-2 flex justify-center space-x-4 md:space-x-1 lg:space-x-2 items-center max-h-20 ">
                                      ...
                                      <button @click="openUpdateStockModal(item)" type="button" id="updateStock" data-micromodal-trigger="modal-1" class="flex items-center text-white text-sm bg-sky-500 border-0 py-2 px-4 focus:outline-none hover:bg-sky-600 rounded">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
