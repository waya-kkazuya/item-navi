                    ...
                    <div class="-m-2">
                      ...
                      <div class="p-4 border bordr-4 mb-4">
                        <div class="p-2 w-full">
                          ...
                          <select name="location_of_use_id" id="location_of_use_id" v-model="form.location_of_use_id"
                            class="md:mt-1 w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-xs md:text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            <option :value="0">選択してください</option>
                      ...
                      <div class="p-4 border bordr-4 mb-4">
                        <div class="p-2 w-full">
                          ...
                          <input type="text" id="manufacturer" name="manufacturer" v-model="form.manufacturer"
                            class="md:mt-1 w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-xs md:text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          <div v-if="errors.manufacturer" class="font-medium text-red-600　text-xs md:text-base">{{ errors.manufacturer }}</div>
                        </div>

                        <div class="p-2 w-full">
                          <label for="reference" class="leading-7 text-xs md:text-base text-blue-900">
                            参考サイト
                            <span class="ml-1 mr-2 bg-gray-400 text-white text-xs md:text-base lg:text-xs py-1 px-2 rounded-md">任意</span>
                          </label>
                          <input type="text" id="reference" name="reference" v-model="form.reference" placeholder="例 Amazonなど"
                            class="md:mt-1 w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-xs md:text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          <div v-if="errors.reference" class="font-medium text-red-600 text-xs md:text-base">{{ errors.reference }}</div>
                        </div>
                        ...
                        <div class="p-2 w-full">
                          ...
                          <input type="number" id="price" name="price" v-model="form.price" min="0"
                            class="md:mt-1 w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-xs md:text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                      ...
                      <div class="p-4 border bordr-4 mb-4">
                        <div class="p-2 w-full">
                          <label for="requestor" class="leading-7 text-xs md:text-base text-blue-900">
                            申請者
                            <span class="ml-1 mr-2 bg-red-400 text-white text-xs md:text-base lg:text-xs py-1 px-2 rounded-md">必須</span>
                          </label>
                          <input type="text" id="requestor" name="requestor" v-model="form.requestor"
                            class="md:mt-1 w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-xs md:text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          <div v-if="errors.requestor" class="font-medium text-red-600 text-xs md:text-base">{{ errors.requestor }}</div>
                        </div>

                        <div class="p-2 w-full">
                          <label for="remarks_from_requestor" class="leading-7 text-xs md:text-base text-blue-900">
                            申請理由
                            <span class="ml-1 mr-2 bg-red-400 text-white text-xs md:text-base lg:text-xs py-1 px-2 rounded-md">必須</span>
                          </label>
                          <textarea id="remarks_from_requestor" name="remarks_from_requestor" maxlength="500"
                            v-model="form.remarks_from_requestor"
                            class="md:mt-1 w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-xs md:text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                          <div v-if="errors.remarks_from_requestor"
                            class="font-medium text-red-600 text-xs md:text-base">{{ errors.remarks_from_requestor }}</div>
                        </div>
                      </div>
