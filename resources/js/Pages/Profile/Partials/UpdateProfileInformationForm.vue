        ...
        <div class="flex justify-center items-center relative">
          ...
          <label for="profile_image_file" class="cursor-pointer">
            <img
              ...
              alt="プロフィール画像"
              class="w-48 h-48 rounded-full object-cover border border-black"
            />
            <div
              v-else
              class="flex items-center justify-center text-4xl text-gray-300 w-48 h-48 rounded-full object-cover border border-gray-300"
            >
              +
            </div>
            <div
              v-if="profileImagePreview"
              class="absolute inset-0 flex justify-center items-center text-4xl text-white"
            >
              +
            </div>
          </label>
