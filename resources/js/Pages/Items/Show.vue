...
<template>
  ...
  <AuthenticatedLayout>
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">備品詳細</h2>
    </template>
                        ...
                        <div class="p-4 border bordr-4 mb-4">
                          <div class="p-2 w-full">
                            ...
                            <div
                              ...
                              class="flex justify-center border border-gray-300 shadow-sm"
                            >
                              ...
                              >
                                {{
                                  uncompleted_inspection
                                    ? uncompleted_inspection.inspection_scheduled_date
                                    : 'なし'
                                }}
                              </div>
                              <div class="w-full">
                            ...
                            <div class="mt-4 leading-7 text-sm">
                              ...
                              {{
                                last_completed_inspection
                                  ? last_completed_inspection.inspection_date
                                  : 'なし'
                              }}
                            </div>
                          </div>
                              ...
                              >
                                {{
                                  item.disposal && item.disposal.disposal_scheduled_date
                                    ? item.disposal.disposal_scheduled_date
                                    : 'なし'
                                }}
                              </div>
                              <div class="w-full">
