                                                    ...
                                                    <div class="p-4 border mb-8 md:mb-0 flex justify-center">
                                                        ...
                                                        <div class="p-2 w-full">
                                                            <label for="fileName" class="leading-7 text-xs md:text-base text-blue-900">
                                                                画像
                                                                <span class="ml-1 bg-gray-400 text-white text-xs md:text-base lg:text-xs py-1 px-2 rounded-md mr-2">任意</span>
                                                            </label>
                                                ...
                                                <div class="col-span-2">
                                                    ...
                                                    <div class="p-4 border mb-4">
                                                        ...
                                                        <div v-show="form.category_id == 1" class="mt-4 pl-2 w-full">
                                                            ...
                                                            <input type="number" id="minimum_stock" name="minimum_stock" v-model="form.minimum_stock" min="0" class="md:mt-1 w-1/4 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-xs md:text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                            <select name="unit" id="unit" v-model="form.unit_id" class="md:w-1/6 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-xs md:text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                                <option v-for="unit in units" :value="unit.id" :key="unit.id">{{ unit.name }}</option>  
                                                            </select>
                                                    ...
                                                    <div class="p-4 border mb-4">
                                                        ...
                                                        <div class="p-2 w-full">
                                                            ...
                                                            <div v-if="errors.end_user" class="font-medium text-red-600 text-xs md:text-base">{{ errors.end_user }}</div>       
                                                        </div>
                                                    ...
                                                    <div class="p-4 border mt-4 bg-red">
                                                        ...
                                                        <div class="p-2 w-full">
                                                            ...
                                                            <div v-if="errors.edit_reason_text" class="font-medium text-red-600 text-xs md:text-base">{{ errors.edit_reason_text }}</div>
                                                        </div>
                                                    </div>
                                                    <div class="p-2 w-full">
                                                        <button id="updateButton" class="flex mx-auto text-white text-xs md:text-sm bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded">
                                                            更新する
                                                        </button>
                                                    </div>
                                                </div>
