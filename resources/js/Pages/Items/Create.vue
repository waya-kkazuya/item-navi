                          ...
                          <div class="p-4 border mb-8 md:mb-0 flex justify-center">
                            ...
                            <div class="p-2 w-full">
                              <label for="imageFile" class="leading-7 text-xs md:text-base text-blue-900">
                                画像
                                <span
                                  class="ml-1 mr-2 bg-gray-400 text-white text-xs md:text-base lg:text-xs py-1 px-2 rounded-md">任意</span>
                              </label>
                              <label for="imageFile" class="cursor-pointer md:flex">
                                <input type="file" @change="handleFileUpload" multiple
                                  accept="image/png, image/jpeg, image/jpg" id="imageFile" name="imageFile"
                                  class="sr-only">
                                <div
                                  ...
                                  <template v-if="file_preview_src">
                                    <img :src=file_preview_src alt="画像プレビュー"
                        ...
                        <div class="col-span-2">
                          <div class="p-4 border mb-4">
                            <div class="p-2 w-full">
                              <label for="name" class="leading-7 text-xs md:text-base text-blue-900">
                                備品名
                                <span
                                  class="ml-1 mr-2 bg-red-400 text-white text-xs md:text-base lg:text-xs py-1 px-2 rounded-md">必須</span>
                              </label>
                          ...
                          <div class="p-4 border mb-4">
                            <div class="pl-2 w-full">
                              ...
                              <input type="number" id="stock" name="stock" v-model="form.stock" min="0"
                              ...
                              <select name="unit" id="unit" v-model="form.unit_id"
                          ...
                          <div class="p-4 border mb-4">
                            ...
                            <div class="p-2 w-full">
                              ...
                              <input type="text" id="end_user" name="end_user" v-model="form.end_user"
                                class="md:mt-1 w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-xs md:text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          ...
                          <div class="p-4 border mb-4">
                            ...
                            <div class="p-2 w-full">
                              ...
                              <div v-if="errors.date_of_acquisition"
                                class="font-medium text-red-600 text-xs md:text-base">{{ errors.date_of_acquisition }}</div>
                            </div>
                          </div>
                          ...
                          <div class="p-4 border mb-4">
                            ...
                            <div class="p-2 w-full">
                              ...
                              <textarea id="remarks" name="remarks" maxlength="500" v-model="form.remarks"
                          ...
                          <div class="p-4 border mb-8">
                            <div class="p-2 w-full">
                              <label for="inspection_scheduled_date"
                              ...
                              <div class="relative">
                                <input type="date" id="inspection_scheduled_date" name="inspection_scheduled_date"
                                  v-model="form.inspection_scheduled_date"
                                  class="md:mt-1 w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-xs md:text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                <button type="button" @click="clearInspectionSchedule"
                            ...
                            <div class="p-2 w-full">
                              ...
                              <div class="relative">
                                ...
                                <button type="button" @click="clearDisposalSchedule"
                                  class="absolute right-12 inset-y-0 flex items-center text-gray-500">
