...
## 1. はじめに
- 本リポジトリは[「waya」(Xアカウント: @waya_dev)」](https://x.com/waya_dev)が作成した備品管理システム[「ItemNavi」](https://itemnavi.biz/)に関するものです
- アプリ作成についての[Qiita記事](https://qiita.com/waya_k/private/b0f373dbec4719210335)を投稿しているので、ご覧いただけますと幸いです
...
### 廃棄済みの備品の表示
![備品の復元](public/images/廃棄済みの備品の表示.gif)
...
### スマホ・タブレットではQRコードボタンから読み取り可能
![スマホQR読取で入出庫](public/images/消耗品をスマホで入出庫.gif)
...
アプリ作成についての[Qiita記事](https://qiita.com/waya_k/private/b0f373dbec4719210335)を投稿しているので、ご覧いただけますと幸いです（Qiita記事には、アプリ自体のご紹介のほか、作成における自身の考えなどもまとめてあります）。
